...
/// 
/// See: https://docs.digi.com/resources/documentation/digidocs/pdfs/90002273.pdf (p.g. 147)
pub enum ATCommands {
    // ==========
    // Networking Commands

    /// Sets the 802.15.4 channel to use for the network.
    /// 
    /// See: https://docs.digi.com/resources/documentation/digidocs/pdfs/90002273.pdf (p.g. 148)
    OperatingChannel(u8),

    /// Sets the Personal Area Network identifier for the device.
    ExtendedPANID(u16),
